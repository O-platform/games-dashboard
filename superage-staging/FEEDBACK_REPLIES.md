...
### subscriber_acquisition table integration (2026-05)

**Request**: Integrate the new `superage.subscriber_acquisition` table to improve acquisition-source attribution across all source-grouped queries.

**Schema**: `email`, `acquisition_date`, `acquisition_utm_source`, `acquisition_status`, `brand`, `dynamo_id`, `message`, `acquisition_sub_level`, `acquisition_sub_source`, `acquisition_o_event`, `ingested_at`.
